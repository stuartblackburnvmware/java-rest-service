...
```json
{
  ...
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=stuartblackburnvmware&repo=java-rest-service",
  "buildTool" : "maven",
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=stuartblackburnvmware&repo=java-rest-service'
